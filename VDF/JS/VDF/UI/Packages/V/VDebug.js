(function()
{
	function Log(message) { if (window.Unity) Unity.invoke("Log", message); else console.log(message); };
	function LinesToString(lines, maxLines, linePrepend)
	{
	...
	Object.defineProperty(Array.prototype, "log", { set: valueSetFunc });
	function valueSetFunc(val)
	{
		if (val === undefined)
			val = "[undefined]";
		else if (val === null)
	...
	window.MarkTime = function(/*;optional*/ postpend)
	{
		postpend = postpend || "";
