...
Object.prototype.AddItem("AddProtoItem", function (name, x, forceAdd) {
    this.prototype.AddItem(name, x, forceAdd);
});
function GetFunctionName(func) {
    return func.name != null ? func.name : func.toString().match(/^function\s*([^\s(]+)/)[1];
}
Object.AddProtoItem("AddFunction", function (value, forceAdd) {
    this.AddItem(GetFunctionName(value), value, forceAdd);
});
Object.AddProtoItem("AddProtoFunction", function (value, forceAdd) {
    this.AddProtoItem(GetFunctionName(value), value, forceAdd);
});

// the below lets you do stuff like this: Array.AddProtoSetterFunction(function AddX(value) { this.push(value); }); [].AddX = "newItem";
Object.AddProtoFunction(function AddSetter(name, x, forceAdd) {
    if (this[name] && forceAdd)
        delete this[name];
    if (!this[name])
        Object.defineProperty(this, name, {
...
Object.AddProtoFunction(function AddProtoSetter(name, x, forceAdd) {
    this.prototype.AddSetter(name, x, forceAdd);
});
Object.AddProtoFunction(function AddSetterFunction(x, forceAdd) {
    this.AddSetter(GetFunctionName(x), x, forceAdd);
});
Object.AddProtoFunction(function AddProtoSetterFunction(x, forceAdd) {
    this.AddProtoSetter(GetFunctionName(x), x, forceAdd);
});

// the below lets you do stuff like this: Array.AddProtoFunction_Inline = function AddX(value) { this.push(value); }; [].AddX = "newItem";
Object.AddProtoSetterFunction(function AddProtoFunction_Inline(value) {
    this.AddProtoFunction(value);
});
Object.AddProtoSetterFunction(function AddProtoSetterFunction_Inline(value) {
    this.AddProtoSetterFunction(value);
});


Object.AddProtoSetterFunction_Inline = function ExtendWith_Inline(value) {
    this.ExtendWith(value);
};
Object.AddProtoFunction_Inline = function ExtendWith(value) {
    $.extend(this, value);
};
...
Object.AddProtoFunction_Inline = function CopyXChildrenAsOwn(x) {
    $.extend(this, x);
};
Object.AddProtoFunction_Inline = function CopyXChildrenToClone(x) {
...
Object.AddProtoFunction_Inline = function ToJson() {
    return JSON.stringify(this);
};


String.AddProtoFunction_Inline = function startsWith(str) {
    return this.lastIndexOf(str, 0) === 0;
};
String.AddProtoFunction_Inline = function endsWith(str) {
    var pos = this.length - str.length;
    return this.indexOf(str, pos) === pos;
};
String.AddProtoFunction_Inline = function contains(str, startIndex) {
...
String.AddProtoFunction_Inline = function splice(index, removeCount, insert) {
    return this.slice(0, index) + insert + this.slice(index + Math.abs(removeCount));
};


Array.AddProtoFunction_Inline = function contains(str) {
    return this.indexOf(str) != -1;
};
Array.AddProtoFunction_Inline = function last() {
...
Array.AddProtoFunction_Inline = function first(matchFunc) {
