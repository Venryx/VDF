System.register(["./VDFExtras", "./VDF", "./VDFSaver", "./VDFLoader", "./VDFTypeInfo"], function (exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var VDFExtras_1, VDF_1, VDFSaver_1, VDFLoader_1, VDFTypeInfo_1, VDFNode;
    return {
        setters: [
        ...
        execute: function () {
            VDFNode = (function () {
                function VDFNode(primitiveValue, metadata) {
                    this.listChildren = new VDFExtras_1.List("VDFNode");
                    this.mapChildren = new VDFExtras_1.Dictionary("VDFNode", "VDFNode"); // this also holds Dictionaries' keys/values
                ...
                VDFNode.prototype.ToVDF_InlinePart = function (options, tabDepth, isKey) {
                    ...
                    var builder = new VDFExtras_1.StringBuilder();
                ...
                VDFNode.prototype.ToVDF_PoppedOutPart = function (options, tabDepth) {
                    ...
                    if (options.useChildPopOut && this.childPopOut) {
                        ...
                        var poppedOutChildTexts = new VDFExtras_1.List("string");
                ...
                VDFNode.prototype.ToObject = function (declaredTypeName_orOptions, options, path) {
                    ...
                    path = path || new VDFExtras_1.VDFNodePath(new VDFExtras_1.VDFNodePathNode());
                    ...
                    if (!deserializedByCustomMethod)
                        ...
                        else if (VDFExtras_1.EnumValue.IsEnum(finalTypeName))
                            result = VDFExtras_1.EnumValue.GetEnumIntForStringValue(finalTypeName, this.primitiveValue);
                ...
                VDFNode.prototype.IntoObject = function (obj, options, path) {
                    ...
                    if (!deserializedByCustomMethod2) {
                        ...
                        for (var _i = 0, _a = this.mapChildren.Pairs; _i < _a.length; _i++) {
                            var pair = _a[_i];
                            try {
                                if (obj instanceof VDFExtras_1.Dictionary) {
                    ...
                    if (options.objPostDeserializeFuncs_early.ContainsKey(obj))
                        for (var _b = 0, _c = options.objPostDeserializeFuncs_early.Get(obj); _b < _c.length; _b++) {
                            var func = _c[_b];
                            func();
                        }
                    for (var propName in VDF_1.VDF.GetObjectProps(obj))
                    ...
                    if (options.objPostDeserializeFuncs.ContainsKey(obj))
                        for (var _d = 0, _e = options.objPostDeserializeFuncs.Get(obj); _d < _e.length; _d++) {
                            var func = _e[_d];
                            func();
                        }
                };
