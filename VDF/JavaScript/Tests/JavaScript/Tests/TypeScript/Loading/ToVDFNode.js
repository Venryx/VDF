System.register(["../../../Source/TypeScript/VDFLoader", "../../../Source/TypeScript/VDF", "../../../Source/TypeScript/VDFTokenParser", "../../../Source/TypeScript/VDFExtras", "../GeneralInit"], function (exports_1, context_1) {
    var __moduleName = context_1 && context_1.id;
    function test(name, func) { tests.push({ name: name, func: func }); }
    var VDFLoader_1, VDF_1, VDFTokenParser_1, VDFExtras_1, GeneralInit_1, tests, VDFTests;
    return {
        setters: [
            ...
            (function (VDFTests) {
                ...
                (function (Loading_ToVDFNode) {
                    ...
                    test("D0_Comment", function () {
                        var a = VDFLoader_1.VDFLoader.ToVDFNode("## comment\n\
'Root string.'");
                        a.primitiveValue.Should().Be("Root string.");
                    });
                    test("D0_Comment2", function () {
                        var a = VDFLoader_1.VDFLoader.ToVDFNode("'Root string ends here.'## comment");
                        a.primitiveValue.Should().Be("Root string ends here.");
                    });
                    test("D0_Int", function () {
                        var a = VDFLoader_1.VDFLoader.ToVDFNode("1");
                    ...
                    test("D0_PowerNotation", function () {
                        VDFLoader_1.VDFLoader.ToVDFNode("1e3").primitiveValue.Should().Be(1000); //1 * Math.Pow(10, 3));
                        VDFLoader_1.VDFLoader.ToVDFNode("1e-3").primitiveValue.Should().Be(.001); //1 * Math.Pow(10, -3));
                        VDFLoader_1.VDFLoader.ToVDFNode("-1e3").primitiveValue.Should().Be(-1000); //-(1 * Math.Pow(10, 3)));
                        VDFLoader_1.VDFLoader.ToVDFNode("-1e-3").primitiveValue.Should().Be(-.001); //-(1 * Math.Pow(10, -3)));
                    });
                    test("D0_Infinity", function () {
                        VDFLoader_1.VDFLoader.ToVDFNode("Infinity").primitiveValue.Should().Be(Infinity);
                        VDFLoader_1.VDFLoader.ToVDFNode("-Infinity").primitiveValue.Should().Be(-Infinity);
                    });
                    test("D0_String", function () {
                        var a = VDFLoader_1.VDFLoader.ToVDFNode("'Root string.'");
                        a.primitiveValue.Should().Be("Root string.");
                    });
                    test("D0_StringWithSaveThenLoad", function () {
                        var vdf = VDF_1.VDF.Serialize("Root string.");
                        vdf.Should().Be("\"Root string.\"");
                        var a = VDFLoader_1.VDFLoader.ToVDFNode(vdf);
                        a.primitiveValue.Should().Be("Root string.");
                    });
                    test("D0_StringAsNull", function () {
                        var a = VDF_1.VDF.Deserialize("null", "string");
                        ok(a == null);
                    });
                    test("D0_BaseValue_Literal", function () {
                        var a = VDFLoader_1.VDFLoader.ToVDFNode("'<<\tBase-value string that {needs escaping}.>>'");
                        a.primitiveValue.Should().Be("\tBase-value string that {needs escaping}.");
                    });
                    test("D0_Metadata_Type", function () {
                        var a = VDFLoader_1.VDFLoader.ToVDFNode("string>'Root string.'");
                        a.metadata.Should().Be("string");
                    });
                    test("D0_List", function () {
                        var a = VDFLoader_1.VDFLoader.ToVDFNode("['Root string 1.' 'Root string 2.']", "List(object)");
                    ...
                    test("D0_List_Objects", function () {
                        var a = VDFLoader_1.VDFLoader.ToVDFNode("[{name:'Dan' age:50} {name:'Bob' age:60}]", "List(object)");
                    ...
                    test("D0_List_Literals", function () {
                        var a = VDFLoader_1.VDFLoader.ToVDFNode("['first' '<<second\n\
...
three lines".Fix());
                    ...
                    test("D0_EmptyList", function () { VDF_1.VDF.Deserialize("[]").Count.Should().Be(0); });
                    test("D0_ListMetadata", function () {
                        var a = VDFLoader_1.VDFLoader.ToVDFNode("List(int)>[1 2]");
                    ...
                    test("D0_ListMetadata2", function () {
                        var a = VDFLoader_1.VDFLoader.ToVDFNode("List(object)>[string>\"1\" string>\"2\"]");
                        a.metadata.Should().Be("List(object)");
                        a[0].metadata.Should().Be("string");
                        a[1].metadata.Should().Be("string");
                    });
                    test("D0_EmptyMap", function () { VDF_1.VDF.Deserialize("{}").Count.Should().Be(0); });
                    test("D0_Map_ChildMetadata", function () {
                        var a = VDFLoader_1.VDFLoader.ToVDFNode("Dictionary(object object)>{a:string>\"1\" b:string>\"2\"}");
                    ...
                    test("D0_MultilineString", function () {
                        var a = VDFLoader_1.VDFLoader.ToVDFNode("'<<This is a\n\
multiline string\n\
...
of three lines in total.".Fix());
            ...
            `);
                    ...
                    test("D1_Map_ChildrenThatAreRetrievedByKey", function () {
                        var a = VDFLoader_1.VDFLoader.ToVDFNode("{key 1:'value 1' key 2:'value 2'}");
                    ...
                    test("D1_List_StringThatKeepsStringTypeFromVDFEvenWithObjectTypeFromCode", function () {
                        var a = VDF_1.VDF.Deserialize("['SimpleString']", "List(object)");
                        a[0].Should().Be("SimpleString");
                    });
                    test("D1_BaseValuesWithImplicitCasting", function () {
                        var a = VDFLoader_1.VDFLoader.ToVDFNode("{bool:false int:5 double:.5 string:'Prop value string.'}");
                    ...
                    test("D1_BaseValuesWithMarkedTypes", function () {
                        var a = VDFLoader_1.VDFLoader.ToVDFNode("{bool:bool>false int:int>5 double:double>.5 string:string>'Prop value string.'}");
                        a["bool"].primitiveValue.Should().Be(false);
                        a["int"].primitiveValue.Should().Be(5);
                        a["double"].primitiveValue.Should().Be(.5);
                        a["string"].primitiveValue.Should().Be("Prop value string.");
                    ...
                    test("D1_Literal", function () {
                        var a = VDFLoader_1.VDFLoader.ToVDFNode("{string:'<<<Prop value string that <<needs escaping>>.>>>'}");
                    ...
                    test("D1_VDFWithVDFWithVDF", function () {
                        var a = VDFLoader_1.VDFLoader.ToVDFNode("{level1:'<<<{level2:'<<{level3:'Base string.'}>>'}>>>'}");
                        a["level1"].primitiveValue.Should().Be("{level2:'<<{level3:'Base string.'}>>'}");
                        VDFLoader_1.VDFLoader.ToVDFNode(a["level1"].primitiveValue)["level2"].primitiveValue.Should().Be("{level3:'Base string.'}");
                        VDFLoader_1.VDFLoader.ToVDFNode(VDFLoader_1.VDFLoader.ToVDFNode(a["level1"].primitiveValue)["level2"].primitiveValue)["level3"].primitiveValue.Should().Be("Base string.");
                    });
                    test("D1_ArraysInArrays", function () {
                        var a = VDFLoader_1.VDFLoader.ToVDFNode("[['1A' '1B'] ['2A' '2B'] '3A']");
                    ...
                    test("D1_ArraysInArrays_SecondsNullAndEmpty", function () {
                        var a = VDFLoader_1.VDFLoader.ToVDFNode("[['1A' null] ['2A' '']]");
                        a[0][0].primitiveValue.Should().Be("1A");
                    ...
                    test("D1_StringAndArraysInArrays", function () {
                        var a = VDFLoader_1.VDFLoader.ToVDFNode("['text' ['2A' null]]");
                    ...
                    test("D1_Dictionary", function () {
                        var a = VDFLoader_1.VDFLoader.ToVDFNode("{key1:'value1' key2:'value2' 'key3':'value3' \"key4\":\"value4\"}");
                    ...
                    test("D1_Map_KeyWithHash", function () {
                        var a = VDFLoader_1.VDFLoader.ToVDFNode("{#:'value1'}");
                        a["#"].primitiveValue.Should().Be("value1");
                    });
                    test("D1_Map_MixedTypeKeysWithMetadata", function () {
                        var a = VDFLoader_1.VDFLoader.ToVDFNode("{int>1:'value1' int>\"2\":'value2' 'key3':'value3' \"key4\":\"value4\"}");
                        ...
                        a["key4"].primitiveValue.Should().Be("value4");
                        var b = a.ToObject();
                        ok(b instanceof VDFExtras_1.Dictionary && b.keyType == "object" && b.valueType == "object");
                        var bMap = b;
                    ...
                    test("D1_Dictionary_Complex", function () {
                        var a = VDFLoader_1.VDFLoader.ToVDFNode("{uiPrefs:{toolOptions:'<<{Select:{} TerrainShape:{showPreview:true continuousMode:true strength:.3 size:7} TerrainTexture:{textureName:null size:7}}>>' liveTool:'Select'}}");
                    ...
                    test("D1_Dictionary_TypesInferredFromGenerics", function () {
                        var a = VDFLoader_1.VDFLoader.ToVDFNode("{vertexColors:Dictionary(string Color)>{9,4,2.5:'Black' 1,8,9.5435:'Gray' 25,15,5:'White'}}");
                    ...
                    test("D1_ArrayPoppedOut_NoItems", function () {
                        var a = VDFLoader_1.VDFLoader.ToVDFNode("{names:[^]}");
                        a["names"].listChildren.Count.Should().Be(0);
                        a["names"].mapChildren.Count.Should().Be(0);
                    });
                    test("D1_ArrayPoppedOut", function () {
                        var vdf = "{names:[^]}\n\t'Dan'\n\t'Bob'";
                        var tokens = VDFTokenParser_1.VDFTokenParser.ParseTokens(vdf);
                        var tokenTypes = tokens.Select(function (b) { return VDFTokenParser_1.VDFTokenType[b.type]; });
                        tokenTypes.Should().BeEquivalentTo(new VDFExtras_1.List("VDFTokenType", VDFTokenParser_1.VDFTokenType.MapStartMarker, VDFTokenParser_1.VDFTokenType.Key, VDFTokenParser_1.VDFTokenType.ListStartMarker, VDFTokenParser_1.VDFTokenType.String, VDFTokenParser_1.VDFTokenType.String, VDFTokenParser_1.VDFTokenType.ListEndMarker, VDFTokenParser_1.VDFTokenType.MapEndMarker).Select(function (a) { return VDFTokenParser_1.VDFTokenType[a]; }));
                        var a = VDFLoader_1.VDFLoader.ToVDFNode(vdf);
                    ...
                    test("D1_ArraysPoppedOut", function () {
                        ...
                        var tokens = VDFTokenParser_1.VDFTokenParser.ParseTokens(vdf);
                        var tokenTypes = tokens.Select(function (b) { return VDFTokenParser_1.VDFTokenType[b.type]; });
                        tokenTypes.Should().BeEquivalentTo(new VDFExtras_1.List("VDFTokenType", VDFTokenParser_1.VDFTokenType.MapStartMarker, VDFTokenParser_1.VDFTokenType.Key, VDFTokenParser_1.VDFTokenType.ListStartMarker, VDFTokenParser_1.VDFTokenType.String, VDFTokenParser_1.VDFTokenType.String, VDFTokenParser_1.VDFTokenType.ListEndMarker, VDFTokenParser_1.VDFTokenType.Key, VDFTokenParser_1.VDFTokenType.ListStartMarker, VDFTokenParser_1.VDFTokenType.Number, VDFTokenParser_1.VDFTokenType.Number, VDFTokenParser_1.VDFTokenType.ListEndMarker, VDFTokenParser_1.VDFTokenType.MapEndMarker).Select(function (a) { return VDFTokenParser_1.VDFTokenType[a]; }));
                        var a = VDFLoader_1.VDFLoader.ToVDFNode(vdf);
                        a["names"][0].primitiveValue.Should().Be("Dan");
                        a["names"][1].primitiveValue.Should().Be("Bob");
                    ...
                    test("D1_InferredDictionaryPoppedOut", function () {
                        var a = VDFLoader_1.VDFLoader.ToVDFNode("{messages:{^} otherProperty:false}\n\
	title1:'message1'\n\
	title2:'message2'");
	...
	title2:'message2'");
                    ...
                    test("D1_Object_MultilineStringThenProperty", function () {
                        var a = VDFLoader_1.VDFLoader.ToVDFNode("{text:'<<This is a\n\
multiline string\n\
...
of three lines in total.".Fix());
                    ...
                    test("D1_Object_PoppedOutStringsThenMultilineString", function () {
                        var a = VDFLoader_1.VDFLoader.ToVDFNode("{childTexts:[^] text:'<<This is a\n\
multiline string\n\
of three lines in total.>>'}\n\
	'text1'\n\
	'text2'");
...
of three lines in total.".Fix());
	...
	line2>>'}");
                    ...
                    test("D2_Object_PoppedOutObject_PoppedOutObject", function () {
                        var a = VDFLoader_1.VDFLoader.ToVDFNode("{name:'L0' children:[^]}\n\
	{name:'L1' children:[^]}\n\
		{name:'L2'}");
	...
	{id:'743f64f2-8ece-4dd3-bdf5-bbb6378ffce5' typeName:'Wood' name:'FrontBar' pivotPoint_unit:'-0.4375,0.5625,0.8125' anchorNormal:'0,0,1' scale:'1,0.25,0.25' controller:false}".replace(/\r\n/g, "\n");
                        var tokens = VDFTokenParser_1.VDFTokenParser.ParseTokens(vdf1, null, true, false);
                        // shift each within-string literal-end-marker token to after its containing-string's token
                        for (var i = 0; i < tokens.Count; i++) {
                            if (tokens[i].type == VDFTokenParser_1.VDFTokenType.LiteralEndMarker && tokens[i + 1].type == VDFTokenParser_1.VDFTokenType.String) {
	...
	^{id:System.Guid>'08e84f18-aecf-4b80-9c3f-ae0697d9033a' name:'#Types' children:[]}";
                        var livePackNode = VDFLoader_1.VDFLoader.ToVDFNode(vdf);
...
//# sourceMappingURL=ToVDFNode.js.map