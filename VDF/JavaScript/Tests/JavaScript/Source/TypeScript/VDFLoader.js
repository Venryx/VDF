                    ...
                    if (firstNonMetadataToken.type == VDFTokenParser_1.VDFTokenType.Null)
                        ...
                        for (var i = 0; i < tokensAtDepth1.Count; i++) {
                            ...
                            if (token.type != VDFTokenParser_1.VDFTokenType.ListEndMarker && token.type != VDFTokenParser_1.VDFTokenType.MapEndMarker) {
                                ...
                                var itemEnderToken = tokensAtDepth1.FirstOrX(function (a) { return a.index > itemFirstToken.index + (itemFirstToken.type == VDFTokenParser_1.VDFTokenType.Metadata ? 1 : 0) && token.type != VDFTokenParser_1.VDFTokenType.ListEndMarker && token.type != VDFTokenParser_1.VDFTokenType.MapEndMarker; });
                        ...
                        for (var i = 0; i < tokensAtDepth1.Count; i++) {
                            ...
                            if (token.type == VDFTokenParser_1.VDFTokenType.Key) {
                                ...
                                var propValueEnderToken = tokensAtDepth1.FirstOrX(function (a) { return a.index > propValueFirstToken.index && a.type == VDFTokenParser_1.VDFTokenType.Key; });
