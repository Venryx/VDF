System.register(["./VDFExtras", "./VDFLoader"], function (exports_1, context_1) {
    var __moduleName = context_1 && context_1.id;
    var VDFExtras_1, VDFLoader_1, VDFTokenType, VDFToken, VDFTokenParser, TokenSet;
    return {
        setters: [
        ...
        execute: function () {
            ...
            exports_1("VDFTokenType", VDFTokenType);
            VDFToken = (function () {
            ...
            VDFTokenParser = (function () {
                ...
                VDFTokenParser.ParseTokens = function (text, options, parseAllTokens, postProcessTokens) {
                    ...
                    var result = new VDFExtras_1.List("VDFToken");
                    var currentTokenFirstCharPos = 0;
                    var currentTokenTextBuilder = new VDFExtras_1.StringBuilder();
                                    ...
                                    switch (ch) {
                                        case '#':
                                            if (nextChar == '#' && firstTokenChar) {
                                                currentTokenTextBuilder = new VDFExtras_1.StringBuilder(text.substr(i, (text.indexOf("\n", i + 1) != -1 ? text.indexOf("\n", i + 1) : text.length) - i));
                ...
                VDFTokenParser.PostProcessTokens = function (origTokens, options) {
                    ...
                    var groupDepth_tokenSetsToProcessAfterGroupEnds = new VDFExtras_1.Dictionary("int", "List(VDFToken)");
                    var tokenSetsToProcess = [];
                    // maybe temp: add depth-0-ender helper token
                    tokenSetsToProcess.push(new TokenSet(new VDFExtras_1.List("VDFToken", new VDFToken(VDFTokenType.None, -1, -1, ""))));
            ...
            VDFTokenParser.charsAToZ = new (VDFExtras_1.List.bind.apply(VDFExtras_1.List, [void 0, "string"].concat("abcdefghijklmnopqrstuvwxyz".match(/./g))))();
            VDFTokenParser.chars0To9DotAndNegative = new (VDFExtras_1.List.bind.apply(VDFExtras_1.List, [void 0, "string"].concat("0123456789\.\-\+eE".match(/./g))))();
