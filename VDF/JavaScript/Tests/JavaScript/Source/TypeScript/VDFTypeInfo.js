        ...
        execute: function () {
            ...
            VDFPropInfo = (function () {
                function VDFPropInfo(propName, propTypeName, tags) {
                    ...
                    this.tags = new VDFExtras_1.List();
                    this.propTag = this.tags.FirstOrX(function (a) { return a instanceof VDFProp; });
                    this.defaultValueTag = this.tags.FirstOrX(function (a) { return a instanceof DefaultValue; });
                }
